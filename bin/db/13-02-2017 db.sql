...
CREATE TABLE `company` (
  ...
  `clr_body_bg` varchar(10) DEFAULT '#ffffff',
  `clr_body_txt` varchar(10) DEFAULT '#333333',
  `clr_popup_border` varchar(10) DEFAULT '#333333',
  `clr_popup_bg` varchar(10) DEFAULT '#ffffff',
  `clr_popup_txt` varchar(10) DEFAULT '#333333',
...
insert  into `company`(`id`,`name`,`address`,`slogon`,`email`,`tp_1`,`tp_2`,`fax`,`clr_header_bg`,`clr_header_txt`,`clr_subheader_bg`,`clr_subheader_txt`,`clr_body_bg`,`clr_body_txt`,`clr_popup_border`,`clr_popup_bg`,`clr_popup_txt`,`online`) values (1,'Studio Thilan','Mawanella','Best Studio','thilan@email.com','+94357874949','+94778541235','+94356587489','#29b711','#ffffff','#e8e8e8','#393939','#ffffff','#333333','#6ca2dd','#ffffff','#333333',1);
...
insert  into `payment_type`(`id`,`name`,`online`,`created`) values (1,'ADVANCE PAYMENT',1,'2017-02-13 12:35:42'),(2,'FULL PAYMETN',1,'2017-02-13 12:36:03'),(3,'INSTALLMENT PAYMENT',1,'2017-02-13 12:36:27');
...
insert  into `users`(`id`,`name`,`nic`,`address`,`tp_fixed`,`tp_mobile`,`dob`,`created`,`last_logged`,`online`,`username`,`password`,`email`,`company_id`,`user_levels_id`) values (1,'Viraj Vimukthi','901430040V','Moragammana, Aranayaka.','0772861046','0718784949','1990-07-11','2017-01-18 21:17:32','2017-02-13 08:44:53',1,'viraj','21232f297a57a5a743894a0e4a801fc3','viraj.vimu@gmail.com',1,1);
...
insert  into `wrk_order_has_items`(`id`,`name`,`cost`,`selling`,`min_price`,`max_price`,`qty`,`amount`,`items_id`,`wrk_order_id`) values (7,'4R Size','350.00','505.50','400.00','750.00','2.00','1011.00',1,3),(8,'6R Size','200.00','450.25','300.00','800.00','1.00','450.25',3,3),(9,'4R Size','350.00','505.50','400.00','750.00','5.00','2527.50',1,4);
