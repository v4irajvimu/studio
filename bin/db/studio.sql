...
insert  into `company`(`id`,`name`,`address`,`slogon`,`email`,`tp_1`,`tp_2`,`fax`) values (1,'Studio Thilan','Mawanella','Best Studio','thilan@email.com','0357874949','0778541235','0356587489');
...
insert  into `users`(`id`,`name`,`nic`,`address`,`tp_fixed`,`tp_mobile`,`dob`,`created`,`last_logged`,`online`,`username`,`password`,`email`,`company_id`,`user_levels_id`) values (1,'Viraj Vimukthi','901430040V','Moragammana, Aranayaka.','0772861046','0718784949','1990-07-11','2017-01-18 21:17:32','2017-01-27 16:20:56',1,'viraj','21232f297a57a5a743894a0e4a801fc3','viraj.vimu@gmail.com',1,1);
...
insert  into `wo_status`(`id`,`name`,`online`,`created`) values (1,'PENDING',1,'2017-01-25 20:57:39'),(2,'COMPLETED',1,'2017-01-25 20:57:41'),(3,'CANCELED',1,'2017-01-25 20:58:16');
...
insert  into `wrk_order`(`id`,`name`,`code`,`eff_date`,`wo_type`,`delivery_date`,`remark`,`wo_status_id`,`customer_id`,`created`,`customer_name`) values (2,'Test Cash Sale','CS_25012017_00001','2017-01-25','CASH','2017-01-27 00:00:00','csasdasdasdsdfs',1,2,'2017-01-25 19:41:05','Viraj Vimukthi Jayasinghe');
