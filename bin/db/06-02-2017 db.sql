...
insert  into `company`(`id`,`name`,`address`,`slogon`,`email`,`tp_1`,`tp_2`,`fax`,`clr_header_bg`,`clr_header_txt`,`clr_subheader_bg`,`clr_subheader_txt`,`clr_body_bg`,`clr_body_txt`,`clr_popup_border`,`clr_popup_bg`,`clr_popup_txt`) values (1,'Studio Thilan','Mawanella','Best Studio','thilan@email.com','0357874949','0778541235','0356587489','#0080c7','#ffffff','#e8e8e8','#393939','#ffffff','#333333','#333333','#ffffff','#333333');
...
insert  into `users`(`id`,`name`,`nic`,`address`,`tp_fixed`,`tp_mobile`,`dob`,`created`,`last_logged`,`online`,`username`,`password`,`email`,`company_id`,`user_levels_id`) values (1,'Viraj Vimukthi','901430040V','Moragammana, Aranayaka.','0772861046','0718784949','1990-07-11','2017-01-18 21:17:32','2017-02-04 16:14:15',1,'viraj','21232f297a57a5a743894a0e4a801fc3','viraj.vimu@gmail.com',1,1);
...
insert  into `wrk_order`(`id`,`code`,`eff_date`,`wo_type`,`delivery_date`,`remark`,`wo_status_id`,`customer_id`,`created`,`customer_name`,`discount_type_id`,`discount`,`total`,`discount_percentage`) values (3,'CS_01022017_00002','2017-02-01','CASH','2017-02-24','sdfsdfdsf',1,1,'2017-02-01 16:47:37','Prasad Viuthi',2,'0.00','1461.25','10.00');
...
insert  into `wrk_order_has_items`(`id`,`name`,`cost`,`selling`,`min_price`,`max_price`,`qty`,`amount`,`items_id`,`wrk_order_id`) values (7,'4R Size','350.00','505.50','400.00','750.00','2.00','1011.00',1,3),(8,'6R Size','200.00','450.25','300.00','800.00','1.00','450.25',3,3);
