...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
        ...
        <body>
            <div class="container-fluid" >
                <div class="row" style="margin-top: 15vh">
                    <div class="col-sm-6 col-sm-push-5" style="box-shadow: 1px 1px 10px #292929; vertical-align: central; ">
    <!--                        <div class="row" style="width: 100%; height: 80px; background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/images/logo.png'); background-repeat: no-repeat; background-size: 50% 85%; background-position: center; ">

                        </div>-->
                        <h3 style="text-align: center; font-weight: bolder; font-size: 25px; ">Administrative System Login</h3>
                        <div class="panel panel-default " style="margin-top: 10px;">
                            <div class="panel-heading" style="text-align: center; "> <strong>Welcome to MEDICAL CENTER Admin Panel</strong></div>
                            <div class="panel-body">
                                <div class="form">
    <?php
    $model = new LoginForm();
    ...
    ?>
                                    ...
                                    <div class="form">
                                        ...
                                        <?php echo $form->labelEx($model, 'username', array('class' => 'control-label')); ?>
                                            ...
                                            <?php echo $form->textField($model, 'username', array('size' => 60, 'required' => 'true', 'maxlength' => 150, 'class' => 'form-control', 'placeholder' => 'Enter Username Here')); ?>
                                            <?php echo $form->error($model, 'username'); ?>
    ...
    <?php echo $form->labelEx($model, 'password', array('class' => 'control-label')); ?>
                                            ...
                                            <?php echo $form->passwordField($model, 'password', array('size' => 60, 'required' => 'true', 'maxlength' => 150, 'class' => 'form-control', 'placeholder' => 'Enter Password Here')); ?>
                                            <?php echo $form->error($model, 'password'); ?>
