...
class UserLogsController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = UserLogs::model()->findByPk($id);
	...
	{
		$model=UserLogs::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserLogs $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-logs-form')
		{
