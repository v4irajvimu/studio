...
class TransTypeController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = TransType::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM trans_type WHERE online = 1 $searchtxt ORDER BY name ASC ";                
	...
	{
		$model=new TransType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TransType']))
			$model->attributes=$_GET['TransType'];
	 ...
	 * @return TransType the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TransType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TransType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='trans-type-form')
		{
