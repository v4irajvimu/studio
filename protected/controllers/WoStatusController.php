...
class WoStatusController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = WoStatus::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM wo_status WHERE online = 1 $searchtxt ORDER BY name ASC ";                
	...
	{
		$model=new WoStatus('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['WoStatus']))
			$model->attributes=$_GET['WoStatus'];
	 ...
	 * @return WoStatus the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=WoStatus::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param WoStatus $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='wo-status-form')
		{
