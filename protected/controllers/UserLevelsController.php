...
class UserLevelsController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = UserLevels::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM user_levels WHERE online = 1 $searchtxt ORDER BY name ASC ";                
	...
	{
		$model=new UserLevels('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UserLevels']))
			$model->attributes=$_GET['UserLevels'];
	...
	{
		$model=UserLevels::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserLevels $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-levels-form')
		{
