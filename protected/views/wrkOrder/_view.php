   ...
   ?>
    ...
    <div class='col-sm-1 cells btn-cog text-right'>
      ...
      if($data['status'] == "PENDING"){
        ?>
        <a class="" target="_blank" href="<?php echo Yii::app()->createUrl("wrkOrder") ?>/payment/<?php echo $data['id']; ?>" data-id="<?php echo $data['id']; ?>" model="WrkOrder" controler="WrkOrderController" data-toggle="tooltip" data-placement="top" title="Payments"><span class="glyphicon glyphicon-usd"></span></a>
